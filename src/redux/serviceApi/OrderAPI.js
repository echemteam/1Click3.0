...
const OrderAPI = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getRecentOrdersByUserId: builder.query({
      query: () => ({
        url: "/Order/GetRecentOrdersByUserId",
        method: "GET",
      }),
      transformResponse: transformSucessResponse,
      transformErrorResponse: transformErrorResponse,
...
export const {useLazyGetOrderHistoryQuery, useAddEditOrderAddressMutation,useLazyGetCheckoutTabDataByOrderIdQuery,useLazyCheckPoNumberQuery,
    usePlaceOrderMutation,useLazyGetItemByOrderIdQuery,useAddEditOrderItemMutation,useLazyGetOrderDetailsbyOrderIdQuery,useLazyGetPaymentOptionbyOrderIdQuery,useAddEditOrderDetailMutation, useLazyGetRecentOrdersByUserIdQuery} = OrderAPI;
