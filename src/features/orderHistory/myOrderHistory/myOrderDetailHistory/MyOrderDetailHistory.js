...
import "./MyOrderDetailHistory.scss";
...
const MyOrderDetailHistory = () => {
  ...
  const [
    getShipingAddressDetailsByAddressId,
    {
      data: GetShippingAddressDetailsByAddressIdData,
      isSuccess: isShippingGetAddressDetailsByAddressIdSuccess,
      isFetching: isGetShippingAddressDetailsByAddressIdFetching,
    },
  ] = useLazyGetAddressDetailsByAddressIdQuery();
  const [
    getBillingAddressDetailsByAddressId,
    {
      data: GetBillingAddressDetailsByAddressIdData,
      isSuccess: isGetBillingAddressDetailsByAddressIdSuccess,
      isFetching: isGetBillingAddressDetailsByAddressIdFetching,
    },
  ] = useLazyGetAddressDetailsByAddressIdQuery();
  ...
  useEffect(() => {
    ...
    useEffect(() => {
    if (
      !isGetOrderDetailsbyOrderIdFetching &&
      isGetOrderDetailsbyOrderIdSuccess &&
      isGetOrderDetailsbyOrderIdData
    ) {
  ...
  useEffect(() => {
    if (orderDetails) {
      getBillingAddressDetailsByAddressId({
        addressId: orderDetails.billingAddressId,
      });
      getShipingAddressDetailsByAddressId({
        addressId: orderDetails.shippingAddressId,
      });
    }
  }, [orderDetails]);
  useEffect(() => {
    if (
      !isGetShippingAddressDetailsByAddressIdFetching &&
      isShippingGetAddressDetailsByAddressIdSuccess &&
      GetShippingAddressDetailsByAddressIdData
    ) {
  ...
  useEffect(() => {
    if (
      !isGetBillingAddressDetailsByAddressIdFetching &&
      isGetBillingAddressDetailsByAddressIdSuccess &&
      GetBillingAddressDetailsByAddressIdData
    ) {
            ...
            <div className="order-note">
              {/* <div className="order-note_note">
                ...
                <p className="order-note_note_note-content">
                  ...
                  specimen book. Lorem Ipsum is simply
                </p>
              </div> */}
                ...
                <div className="order-note_bill-detail_detail">
                  ...
                  {orderDetails?.cardProcessingCharges !== 0 && (
                    <>
                      ...
                      <span>
                        ${orderDetails?.cardProcessingCharges?.toFixed(2)}
                      </span>
                    </>
                  )}
            ...
            <div className="cart-info-form">
              <div className="cart-info-form_section">
                ...
                <div className="cart-heading">
                  ...
                  <span className="heading-total primary">
              ...
              <div className="cart-info-form_section">
                ...
                <div className="order-address">
                  <span>
                    ...
                    {billingAddress?.cityName} {billingAddress?.zipCode}
                  </span>
                  <span>
              ...
              <div className="cart-info-form_section">
                ...
                <div className="order-address">
                  <span>
                    ...
                    {shippingAddress?.cityName} {shippingAddress?.zipCode}
                  </span>
                  <span>
                    <Iconify icon="gis:location-poi" width={30} />
                  </span>
...
export default MyOrderDetailHistory;
