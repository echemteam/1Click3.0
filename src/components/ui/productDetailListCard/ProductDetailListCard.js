...
import "./ProductDetailListCard.scss";
    ...
    <div className="product-detail-list-card-container">
      ...
      <div className="product-detail-list-card-container__detail">
        <div>
          ...
          {/* {description && (
            <div className="product-detail-list-card-detail-description">
...
ProductDetailListCard.propTypes = {
...
export default ProductDetailListCard;
